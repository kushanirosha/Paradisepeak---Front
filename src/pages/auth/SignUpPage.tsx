...
function SignUp() {
  ...
  const images = [
    "https://images.unsplash.com/photo-1666845992003-adaa79a59bf8?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzV8fG1hbGRpdmVzfGVufDB8fDB8fHww",
    "https://images.unsplash.com/photo-1682308999971-208126ba75ec?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Njh8fG1hbGRpdmVzfGVufDB8fDB8fHww",
    "https://images.unsplash.com/photo-1667114714584-b7f122d4b1c9?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjE2fHxtYWxkaXZlc3xlbnwwfHwwfHx8MA%3D%3D"
  ]
      ...
      try {
          ...
          //  console.log(userData.message);
              ...
              if (axios.isAxiosError(err)) {
                ...
                // Axios error
                errorToastMsg(err.response?.data?.error);
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-1">
              Welcome to Paradise peak Travels!
            </h2>
