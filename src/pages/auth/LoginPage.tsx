        ...
        <div className="w-full max-w-sm">
          ...
          <form className="space-y-3" onSubmit={handleLogin}>
            <div>
              ...
              <input
                type="email"
                placeholder="Enter your email" onChange={e => setValues({...values, email: e.target.value})}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="Enter your password" onChange={e => setValues({...values, password: e.target.value})}
