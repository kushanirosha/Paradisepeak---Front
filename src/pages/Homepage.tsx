...
const topdestination = [
  { id: 1, src: "/pic1.jpg", alt: "Banner 1", place: "Sri Lanka" },
...
{/* start picture content */}
          ...
          <div className='w-70 h-50 md:h-50 relative mt-10 mx-20  '> <img
            ...
            <div className='mt-10 mx-20 font-kyiv text-2xl  font-bold '>
              ...
              <div className="max-w-4xl mx-auto  text-sm font-light  text-gray-700 leading-relaxed ">
                ...
                <p>
                  All dive trips are led by dive masters with many years of Travel experience
                  and an in-depth knowledge of local dive sites. Our team has experience in
                  wreck exploration, technical Travel, underwater photography and marine
                  research, with extensive Travel experience around Sri Lanka and outside.
   ...
   {/* end picture content */} 
      ...
      <p className="mt-4 max-w-xl text-gray-700 text-sm font-light">
        ...
        Travel experiences tailored to your skill level and interests.
      </p>
    </div>
    {/* end Travel */}
    ...
    <div className='pl-20 grid grid-cols-4 gap-4 pt-10'>
      {/* first */}
              ...
              <div
                  ...
                  {/* para start */}
                  <div className='pt-4 font-lights'>
                  Explore Sri Lanka’s Travel spots including coral reefs, shipwrecks, and marine sanctuaries 
                  </div>
                   {/* start ul tag */}
                  <div>
                    <ul className="custom-bullet">
   ...
   <div className='center-column'>
          <div className='gradient-text'>
           ...
           <div className='mt-4 max-w-xl text-gray-700 text-sm font-light'>
            Book a trip to one of the world’s top Travel destinations in sri Lanaka
            </div>
   </div>
        {/* end title */}
        {/* startimag */}
